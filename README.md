...
|:----------:|:---------------------------:|:-------------------:|:------:|:----:|:--------:|
| UNEAR      | 구독 혜택 추천 플랫폼 | 25.07.01 ~ 25.08.12 (6주) | [GitHub](https://) | 최우수상 | LGU+ 유레카 |
| Archi      | AI 기반 아키텍처 챗봇 서비스 | 25.06 ~ YYYY.06 (4주) | [GitHub](https://) | 우수상 | LGU+ 유레카 |
| Planvel    | 여행 계획 자동화 웹 애플리케이션 | 25.05.05 ~ 25.05.16 (2주) | [GitHub](https://) | 팀 리딩 및 프로젝트 관리 |LGU+ 유레카  |
| Talk-o     | 실시간 채팅 기반 스터디 플랫폼 | 25.MM ~ 25.MM | [GitHub](https://) | 스터디 운영 및 기술 세미나 진행  | 개인  |
| Gatheria   | 교육 활동 지원 프로젝트 플랫폼 | 24.12 ~ 25.04 | [GitHub](https://) | OOP/클린 코드 설계 역량 강화 | F-Lab |
| 드론제어   | 다중 드론 제어 시뮬레이션 시스템 | 22.07 ~ 22.12 | [GitHub](https://) | 국내/국제 학술대회 발표 | 한밭대학교 |
| PyrexiaSim | 열사병/일사병 위험 예측 시뮬레이터 | 22.08 ~ 22.11 | [GitHub](https://) | 후속 과제 수주 | 한밭대학교 |
| TEAMate    | 팀원 매칭 및 협업 지원 서비스 | 21.02 ~ 21.12 | [GitHub](https://) | 작품전시회 금상 | 한밭대학교 |
