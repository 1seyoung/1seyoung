...
| 프로젝트 백엔드 개발 <br> REST API 설계·구현 | AI 챗봇 서버(OpenAI, RAG) <br>데이터 정제 및 분석 | SQL/NoSQL 활용<br> 캐싱·실시간 처리·메시징 | 클라우드 기반 배포(AWS) <br> CI/CD, 데이터 파이프라인 구축 | Git 협업 <br> 이슈·태스크 관리 |
